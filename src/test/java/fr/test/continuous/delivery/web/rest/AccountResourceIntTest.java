...
import fr.test.continuous.delivery.SampleDevOpsApp;
import fr.test.continuous.delivery.domain.Authority;
import fr.test.continuous.delivery.domain.User;
import fr.test.continuous.delivery.repository.AuthorityRepository;
...
import fr.test.continuous.delivery.web.rest.errors.ExceptionTranslator;
import fr.test.continuous.delivery.web.rest.vm.KeyAndPasswordVM;
import fr.test.continuous.delivery.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = SampleDevOpsApp.class)
