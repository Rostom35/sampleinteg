package fr.test.continuous.delivery.repository;

import fr.test.continuous.delivery.SampleDevOpsApp;
import fr.test.continuous.delivery.config.Constants;
import fr.test.continuous.delivery.config.audit.AuditEventConverter;
import fr.test.continuous.delivery.domain.PersistentAuditEvent;
...
import static fr.test.continuous.delivery.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
